/**
 * Промежуточный GlobalSign GCC R6 AlphaSSL CA 2023 (публичный).
 * ИИС БГУИР не отдаёт его в TLS-цепочке; без него Node не строит путь к корню.
 * Источник: https://secure.globalsign.com/cacert/gsgccr6alphasslca2023.crt
 */
export const GLOBALSIGN_GCC_R6_ALPHASSL_CA_2023_PEM = `-----BEGIN CERTIFICATE-----
